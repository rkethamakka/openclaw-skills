...
```bash
${PYTHON_BIN}/snow sql -q "SHOW TABLES IN FINANCIAL_PLANNING.PLANNING"
${PYTHON_BIN}/snow sql -q "SHOW USER FUNCTIONS IN FINANCIAL_PLANNING.PLANNING"
${PYTHON_BIN}/snow sql -q "SHOW VIEWS IN FINANCIAL_PLANNING.PLANNING"
${PYTHON_BIN}/snow sql -q "SHOW PROCEDURES IN FINANCIAL_PLANNING.PLANNING"
```
